 ...
 */
public class Map_Base_Setting extends Activity implements AdapterView.OnItemSelectedListener{
    private Button btn_base_setting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_base_setting);
        ...
        InitSpinnerSetting();
        mySpinner.setOnItemSelectedListener(Map_Base_Setting.this);
    ...
    private void InitEvent(){
        iuputtime1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DateTimePickDialogUtil dateTimePicKDialog = new DateTimePickDialogUtil(Map_Base_Setting.this);
