 ...
 */
public class List_TerminalAll implements Parcelable{
    private int num;//序号
    ...
    public List_TerminalAll(int num
            ,String ASICII
            ,String IDcard
    ...
    protected List_TerminalAll(Parcel in) {
        num = in.readInt();
    ...
    public static final Creator<List_TerminalAll> CREATOR = new Creator<List_TerminalAll>() {
        @Override
        public List_TerminalAll createFromParcel(Parcel in) {
            return new List_TerminalAll(in);
        }

        @Override
        public List_TerminalAll[] newArray(int size) {
            return new List_TerminalAll[size];
        }
    };
