...
public class Map_offline extends Activity implements MKOfflineMapListener {

    private MKOfflineMap mOffline = null;   //用于管理离线地图.
    private TextView cidView;
    private TextView stateView;
    private EditText cityNameView;
    private static final String LTAG = Map_offline.class.getSimpleName();
    /**
     * 已下载的离线地图信息列表
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_offline);
    ...
    public void onGetOfflineMapState(int type, int state) {
        switch (type) {
            ...
            case MKOfflineMap.TYPE_NEW_OFFLINE:
                // 有新离线地图安装
                Log.d("Map_offline", String.format("add offlinemap num:%d", state));
                break;
    ...
    public class LocalMapAdapter extends BaseAdapter {
        ...
        public View getView(int index, View view, ViewGroup arg2) {
            ...
            view = View.inflate(Map_offline.this,
        ...
        void initViewItem(View view, final MKOLUpdateElement e) {
            ...
            display.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(Map_offline.this, Map_StationMap.class);
